...
public class UIPreferencesForm extends UIForm implements UIPopupComponent {
  ...
  final static public String FIELD_EDIT_IN_NEW_WINDOW = "editInNewWindow".intern();
  ...
  public UIPreferencesForm() throws Exception {
    ...
    addUIFormInput(new UIFormCheckBoxInput<Boolean>(FIELD_EDIT_IN_NEW_WINDOW,
                                                    FIELD_EDIT_IN_NEW_WINDOW, null));
  ...
  public void update(Preference pref) {
    ...
    getUIFormCheckBoxInput(FIELD_EDIT_IN_NEW_WINDOW).setChecked(pref.isEditInNewWindow());
  ...
  static public class SaveActionListener extends EventListener<UIPreferencesForm> {
    public void execute(Event<UIPreferencesForm> event) throws Exception {
      ...
      pref.setEditInNewWindow(uiForm.getUIFormCheckBoxInput(FIELD_EDIT_IN_NEW_WINDOW).isChecked());
